...
/**
 * Simple seed books data script for Strapi
...
async function main() {
  ...
  try {
    ...
    const categories = await seedCategories(app, csvData);
    
    // Seed authors
    console.log('✍️  Seeding authors...');
    const authors = await seedAuthors(app, csvData);
    
    // Seed books
    console.log('📖 Seeding books...');
    await seedBooks(app, csvData, categories, authors);
